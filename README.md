...
<h1 align="center">The offline, Git-native API workspace.</h1>
...
<p align="center">
  <a href="https://github.com/VoidenHQ/voiden">
...
This project is licensed under the [Apache License 2.0](LICENSE).echo "deb [arch=amd64 signed-by=/etc/apt/keyrings/voiden-beta.gpg] https://voiden.md/apt/beta beta main" | sudo tee /etc/apt/sources.list.d/voiden-beta.list
sudo apt update && sudo apt install voiden
```
